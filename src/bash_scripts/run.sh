...
python src/generate_summary/extract_reason.py --input_dir data/docs/v1/test --output_dir data/docs/v1/test/reason
python src/generate_summary/extract_reason.py --input_dir data/docs/v1/train --output_dir data/docs/v1/train/reason
bash src/bash_scripts/stop_qwen_72b_servers.sh
sleep 15
bash src/bash_scripts/vllm_Qwen72B_server_7280_long.sh
sleep 3m
python src/generate_summary/generate_summary.py
